...
namespace NDSCalc.View.Converters
{
    ...
    {
        private static readonly Dictionary<TextCase, string[]> monthNames = new Dictionary<TextCase, string[]>
    {
        ...
        /// <param name="_firstCapital"></param>
        /// <returns></returns>
        public static string CurrencyToTxtShort(decimal _amount, bool _firstCapital)
        {
            //10 000 рублей 67 копеек        
            long rublesAmount = (long)Math.Floor(_amount);
            long copecksAmount = ((long)Math.Round(_amount * 100)) % 100;
